    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if image is None or image.size == 0:
                return render_template('upload.html', message='Imagem inválida ou vazia')
            ...
            return render_template('upload.html', message=f'Erro durante o processamento da imagem: {str(e)}')

    return render_template('upload.html', predicted_class=predicted_class, confidence_score=confidence_score, encoded_image=encoded_image)
